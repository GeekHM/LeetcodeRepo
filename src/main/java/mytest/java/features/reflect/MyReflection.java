package mytest.java.features.reflect;
...
public class MyReflection {
    ...
    public void myGetClass() throws ClassNotFoundException {
        //使用class的forName方法
        Class<?> personClass1 = Class.forName("mytest.java.features.reflect.Person");//需要加异常处理
        ...
        Class<?> loadClass = classLoader.loadClass("mytest.java.features.reflect.Person");
    }
    ...
    public void usage() throws ClassNotFoundException {
        Class<?> class1 = Class.forName("mytest.java.features.reflect.Person");
